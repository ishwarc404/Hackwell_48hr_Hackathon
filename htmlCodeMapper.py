...
def createInput(submodule, path):
    ...
    addInstructionPath = value_reference_path
    ...
    outerdiv_end = "</div>"
    addInstructionButton = "<br><button id='{}' style='margin-left:10px' class='btn btn-outline-secondary' onclick=addNewInstruction(this.id)>Add new instruction</button><br><br>".format(addInstructionPath)
    return outerdiv_start + batch_mode_checkbox + label + field + addInstructionButton + outerdiv_end